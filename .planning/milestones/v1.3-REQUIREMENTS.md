# Requirements Archive: v1.3 Branding & Context Migration
...
- [x] **CONFIG-01**: `src/carl/` directory is renamed to `src/opencarl/` (Verified: src/opencarl/ exists, src/carl/ removed)
